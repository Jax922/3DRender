#include "BlinnPhongApplication.h"
...
void BlinnPhongApplication::Initialize()
{
...
void BlinnPhongApplication::Update()
{
    Application::Update();
...
void BlinnPhongApplication::Render()
{
    Application::Render();
...
void BlinnPhongApplication::Cleanup()
{
    // Cleanup DearImGUI
    m_imGui.Cleanup();
...
void BlinnPhongApplication::InitializeModel()
{
    ...
    // Load model
    m_model = loader.Load("models/spot.obj");
    ...
    m_model.GetMaterial(0).SetUniformValue("ColorTexture", textureLoader.LoadShared("models/teapot/default.png"));
...
void BlinnPhongApplication::InitializeCamera()
{
...
void BlinnPhongApplication::InitializeLights()
{
...
void BlinnPhongApplication::RenderGUI()
{
    m_imGui.BeginFrame();
...
void BlinnPhongApplication::UpdateCamera()
{
